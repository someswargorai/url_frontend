        ...
        <div className="min-h-screen bg-background relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 py-8 pb-20 relative z-10">
                ...
                <Tabs defaultValue="overview" className="space-y-6">
                    <TabsList className="bg-[#0d0d12] border border-[#1e1e2e] p-1.5 rounded-xl w-full flex overflow-x-auto scrollbar-none flex-no-wrap justify-start h-14 gap-2">
                        <TabsTrigger value="overview" className="px-4 py-2 cursor-pointer rounded-lg font-mono text-xs text-zinc-400 transition-all duration-200 data-[state=active]:bg-[#13131a] data-[state=active]:text-[#00e5a0] data-[state=active]:border border-transparent data-[state=active]:border-[#1e1e2e] hover:text-[#00e5a0]">Overview</TabsTrigger>
                        <TabsTrigger value="analytics" className="px-4 py-2 cursor-pointer rounded-lg font-mono text-xs text-zinc-400 transition-all duration-200 data-[state=active]:bg-[#13131a] data-[state=active]:text-[#00e5a0] data-[state=active]:border border-transparent data-[state=active]:border-[#1e1e2e] hover:text-[#00e5a0]">Analytics</TabsTrigger>
                        <TabsTrigger value="insights" className="px-4 py-2 cursor-pointer rounded-lg font-mono text-xs text-zinc-400 transition-all duration-200 data-[state=active]:bg-[#13131a] data-[state=active]:text-[#00e5a0] data-[state=active]:border border-transparent data-[state=active]:border-[#1e1e2e] hover:text-[#00e5a0]">Insights</TabsTrigger>
                        <TabsTrigger value="logs" className="px-4 py-2 cursor-pointer rounded-lg font-mono text-xs text-zinc-400 transition-all duration-200 data-[state=active]:bg-[#13131a] data-[state=active]:text-[#00e5a0] data-[state=active]:border border-transparent data-[state=active]:border-[#1e1e2e] hover:text-[#00e5a0]">Live Logs</TabsTrigger>
                        <TabsTrigger value="ai-analyst" className="px-4 py-2 cursor-pointer rounded-lg font-mono text-xs text-zinc-400 transition-all duration-200 data-[state=active]:bg-[#7c6df0]/10 data-[state=active]:text-[#7c6df0] data-[state=active]:border border-transparent data-[state=active]:border-[#7c6df0]/20 hover:text-[#7c6df0]">AI Analyst</TabsTrigger>
                    </TabsList>
