        ...
        <div className="container mx-auto px-4 py-8 pb-20 max-w-6xl">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center justify-between gap-2 ">
                            ...
                            <Dialog  open={open}
                                    ...
                                    <UITooltip>
                                        <TooltipTrigger asChild>
                                            <DialogTrigger asChild>
                                                <div className="group relative flex items-center gap-2 px-3 py-2 rounded-md bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 text-indigo-400 hover:text-indigo-300 hover:border-indigo-400/40 cursor-pointer transition-all duration-300 shadow-sm">
                                                    <WandSparkles className="h-4 w-4 transition-transform duration-300 group-hover:rotate-12" />
                                                    <span className="text-xs font-medium tracking-wide">AI Campaign Insights</span>
                                                </div>
                                            </DialogTrigger>
                                        </TooltipTrigger>
                                        <TooltipContent>
                                ...
                                ">
                                    {/* Sticky Header */}
                                    <div className="flex-none flex items-center gap-3.5 p-5 sm:p-7 border-b border-border/50 bg-muted/30 z-50">
                                        <div className="relative shrink-0">
                                            <div className="relative p-2.5 rounded-md bg-indigo-500/10 border border-indigo-500/20 shadow-sm">
                                                <WandSparkles className="h-5 w-5 text-indigo-400" />
                                            </div>
                                        </div>
                                        <div className="min-w-0 flex-1">
                                            <h2 className="text-lg sm:text-lg font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-purple-400 leading-tight">
                                                Campaign Growth Insights
                                            </h2>
                                            <p className="text-xs sm:text-xs text-muted-foreground mt-0.5 font-medium">
                                                Deep analytical intelligence generated for your overall campaign.
                                            </p>
                                        </div>
                                        <DialogClose asChild>
                                            <Button variant="ghost" className="h-8 w-8 p-0 rounded-full text-muted-foreground hover:text-foreground ml-auto shrink-0 cursor-pointer">
                                    ...
                                    <div className="flex-1 overflow-y-auto p-5 sm:p-7 relative space-y-5">
                                        {aiLoading ? (
                                            <div className="space-y-4 py-4">
                                                <div className="flex items-center gap-2.5 text-indigo-400 mb-5">
                                                    <WandSparkles className="h-4 w-4 animate-pulse" />
                                                    <span className="text-xs font-semibold tracking-wide animate-pulse uppercase">Analyzing campaign data…</span>
                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                    ...
                                                    <div className="h-28 w-full rounded-md bg-muted animate-pulse" style={{ animationDelay: '150ms' }} />
                                                    <div className="h-28 w-full rounded-md bg-muted animate-pulse" style={{ animationDelay: '300ms' }} />
                                                    <div className="h-28 w-full rounded-md bg-muted animate-pulse" style={{ animationDelay: '450ms' }} />
                                                </div>
                                            </div>
                                        ) : aiError ? (
                                            ...
                                            <div className="space-y-4 animate-in fade-in slide-in-from-bottom-3 duration-500">
                                                {/* Executive Summary */}
                                                <div className="relative rounded-md overflow-hidden bg-muted/50 border border-border/50 shadow-sm">
                                                    <div className="absolute top-0 left-0 w-[3px] h-full bg-gradient-to-b from-indigo-400 to-purple-500 rounded-l-md" />
                                                    <div className="pl-5 pr-4 py-4 sm:pl-6 sm:py-5">
                                                        <p className="text-[10px] font-bold text-indigo-400 uppercase tracking-[0.12em] mb-2.5">
                                                            Executive Summary
                                                        </p>
                                                        <div
                                                ...
                                                <div className="grid grid-cols-1 gap-3">
                                                    {[
                                                        { label: 'Traffic Patterns',    icon: '📈', content: aiInsights.traffic_pattern,    tag: 'text-indigo-400' },
                                                        { label: 'Audience Behavior',   icon: '👥', content: aiInsights.audience_insights,  tag: 'text-purple-400' },
                                                        { label: 'Referral & Sources',  icon: '🔗', content: aiInsights.referrer_insights,  tag: 'text-orange-400' },
                                                        { label: 'Anomalies Detected',  icon: '🔍', content: aiInsights.anomalies,          tag: 'text-rose-400' },
                                                    ].map(({ label, icon, content, tag }) => (
                                                        <div key={label} className={`relative rounded-md bg-muted/30 border border-border/50 shadow-sm p-4 flex flex-col gap-2.5`}>
                                                            <p className={`text-[10px] font-bold ${tag} uppercase tracking-[0.12em] flex items-center gap-1.5`}>
                                                                <span>{icon}</span>{label}
                                                            </p>
                                                            <div
                                                                className="prose prose-sm dark:prose-invert max-w-none text-muted-foreground leading-relaxed text-[13px]
                                                                    prose-strong:text-foreground prose-strong:font-semibold
                                                                    prose-p:my-0"
                                                ...
                                                <div className="relative rounded-md overflow-hidden bg-emerald-500/10 border border-emerald-500/20 shadow-sm">
                                                    <div className="p-4 sm:p-5">
                                                        <p className="text-[10px] font-bold text-emerald-500 uppercase tracking-[0.12em] mb-3.5 flex items-center gap-1.5">
                                                            <span>🚀</span> Growth Recommendations
                                                        </p>
                                                        <ul className="space-y-3">
                                                            {aiInsights.growth_recommendations.map((rec, idx) => (
                                                                <li key={idx} className="flex items-start gap-3">
                                                                    <div className="mt-[5px] shrink-0 w-1.5 h-1.5 rounded-md bg-emerald-500" />
                                                                    <div
                                                                        className="prose prose-sm dark:prose-invert max-w-none text-muted-foreground leading-relaxed text-[13px] font-medium
                                                                            prose-strong:text-foreground prose-strong:font-semibold
                                                                            prose-p:my-0"
                                                ...
                                                {aiInsights.interesting_insight && (
                                                    <div className="relative rounded-md overflow-hidden bg-muted/50 border border-border/50 shadow-sm p-4">
                                                        <div className="absolute top-0 left-0 w-[3px] h-full bg-purple-500 rounded-l-md" />
                                                        <p className="text-[10px] font-bold text-purple-500 uppercase tracking-[0.12em] mb-2 pl-2">
                                                            ✦ Key Insight
                                                        </p>
                                                        <div
                                                            className="prose prose-sm dark:prose-invert max-w-none text-muted-foreground italic leading-relaxed text-[13px]
                                                                prose-strong:text-foreground prose-strong:not-italic prose-strong:font-semibold
                                                                prose-p:my-0 pl-2"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <StatsCard
                    ...
                    icon={<MousePointerClick className="h-5 w-5 text-indigo-400" />}
                    delay={0.1}
                />
                <StatsCard
                    title="Top Country"
                ...
                <Card className="rounded-md border-border/50 overflow-hidden bg-card/50 backdrop-blur-xl">
                    <CardHeader className="border-b border-border/50 pb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <CardTitle>Aggregated Click History</CardTitle>
                                <CardDescription>Activity across all links in this campaign</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent className="pt-6">
                        <div className="h-[300px] w-full">
                            {formattedClickHistory.length > 0 ? (
                                <ChartContainer config={{ clicks: { label: "Clicks", color: "#6366f1" } }}>
...
function StatsCard({ title, value, icon, delay }: { title: string; value: string | number; icon: React.ReactNode; delay: number }) {
    return (
        <motion.div
            ...
            transition={{ delay }}
        >
            <Card className="border-border/50 rounded-md bg-card/50 backdrop-blur-xl h-[140px]">
